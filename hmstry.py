...
def check_login_credentials(username, password):
    return username.get(username) == password
...
# Create a login box
login_box = tk.Frame(borderwidth=2, relief="ridge", padx=10, pady=10)
...
login_page_button = tk.Button(root, text="Have an account? Log in here.", command=login_box)
